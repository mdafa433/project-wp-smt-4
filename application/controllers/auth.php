...
class auth extends CI_Controller
{
    ...
    {
        //membuat rule untuk inputan nama agar tidak boleh kosong dengan membuat message error dengan 
        ...
        //dan email belum pernah dipakai sama user lain dengan membuat message error dengan bahasa sendiri 
        //yaitu jika format email tidak benar maka messagenya 'Email Tidak Benar!!'. jika email belum diisi,
        //maka messagenya adalah 'Email Belum diisi', dan jika email yang diinput sudah dipakai user lain,
        //maka messagenya 'Email Sudah dipakai'
        ...
        //dari 3 digit, dan password harus sama dengan repeat password dengan membuat message error dengan  
        //bahasa sendiri yaitu jika password dan repeat password tidak diinput sama, maka messagenya
        //'Password Tidak Sama'. jika password diisi kurang dari 3 digit, maka messagenya adalah 
        ...
        if ($this->form_validation->run() == false) {
            ...
            $this->session->set_flashdata('message', '<div class="alert alert-success alert-message" role="alert">Selamat!! akun member anda sudah dibuat. Silahkan Aktivasi Akun anda</div>');
            redirect('auth');
        }
    }
